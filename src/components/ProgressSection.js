    ...
    >
      ...
      >
        <span>
          Status:{" "}
          <span
            className={getStatusClass(progress.status)}
            style={{
              padding: "8px 15px",
              borderRadius: "2px",
              fontWeight: 500,
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, rgba(0, 102, 255, 0.8) 0%, rgba(0, 204, 255, 0.8) 50%, rgba(0, 102, 255, 0.8) 100%)",
            height: "100%",
            width: `${percentage}%`,
      ...
      <div style={{ color: "#88aacc", marginTop: "10px" }}>
      ...
      >
        <button
          ...
          onClick={onStart}
          disabled={progress.status === "running" || !isAuthenticated}
        >
          Start Sending
        </button>
        <button
